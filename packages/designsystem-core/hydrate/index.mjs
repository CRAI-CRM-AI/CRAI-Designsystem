...
const NAMESPACE = 'designsystem-core';
const BUILD = /* designsystem-core */ { hydratedSelectorName: "hydrated", propChangeCallback: false, slotRelocation: true, updatable: true};
