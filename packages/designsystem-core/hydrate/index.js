...
const NAMESPACE = 'crai-designsystem-core';
const BUILD = /* crai-designsystem-core */ { hydratedSelectorName: "hydrated", propChangeCallback: false, slotRelocation: true, updatable: true};

/*
 Stencil Hydrate Platform v4.38.2 | MIT Licensed | https://stenciljs.com
 */
...
class CraiButton {
    ...
    render() {
        return (hAsync(Host, { key: '0ee5f8d27af98d1f5198fa5bb89ceed50d53096a' }, hAsync("button", { key: '8238c08c847ffe910c639dba614231be32723eaa', ref: el => (this.btn = el), onClick: this.handleClick }, hAsync("slot", { key: '302518444e42aa262bfd805e97f21f52a54954d9' }), hAsync(GlassFilter, { key: '704a054803e7c15d9d2514ebc329714642261d61' }))));
    }
...
class MyComponent {
    ...
    render() {
        return hAsync("div", { key: '6e1c425ab59aa8d200e46309d381322113a0456b' }, "Hello, World! I'm ", this.getText());
    }
